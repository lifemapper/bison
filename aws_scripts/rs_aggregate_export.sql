...
CREATE TABLE public.county_counts_2024_01_01 AS
...
CREATE TABLE public.state_counts_2024_01_01 AS
    SELECT DISTINCT census_state, riis_assessment,
           COUNT(*) AS occ_count, COUNT(DISTINCT taxonkey) AS species_count
    FROM  bison_subset_2024_01_01 WHERE census_state IS NOT NULL
    GROUP BY census_state, riis_assessment;
CREATE TABLE public.aiannh_counts_2024_01_01 AS
...
-- Check counts
SELECT * from county_counts_2024_01_01 ORDER BY census_state, census_county, riis_assessment LIMIT 10;
SELECT * from state_counts_2024_01_01 ORDER BY census_state, riis_assessment LIMIT 10;
SELECT * from aiannh_counts_2024_01_01 ORDER BY aiannh_name, riis_assessment LIMIT 10;
...
UNLOAD (
    'SELECT * FROM county_counts_2024_01_01 ORDER BY census_state, census_county, riis_assessment')
    TO 's3://bison-321942852011-us-east-1/out_data/county_counts_'
    IAM_role DEFAULT
    FORMAT AS PARQUET
    PARALLEL OFF;
UNLOAD (
    'SELECT * FROM state_counts_2024_01_01 ORDER BY census_state, riis_assessment')
    TO 's3://bison-321942852011-us-east-1/out_data/state_counts_'
    IAM_role DEFAULT
    FORMAT AS PARQUET
    PARALLEL OFF;
UNLOAD (
    'SELECT * FROM aiannh_counts_2024_01_01 ORDER BY aiannh_name, riis_assessment')
...
DROP TABLE public.county_counts_2024_01_01;
DROP TABLE public.state_counts_2024_01_01;
DROP TABLE public.aiannh_counts_2024_01_01;
-- Save county_lists as input to heatmatrix and PAM
DROP TABLE public.state_lists_2024_01_01;
DROP TABLE public.aiannh_lists_2024_01_01;
