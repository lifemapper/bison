...
# .............................................................................
def annotate_occurrence_file(input_filename, riis_filename, logger):
    """Annotate GBIF records with census state and county, and RIIS key and assessment.

    Args:
        input_filename (str): full filename containing GBIF data for annotation.
        riis_filename (str): full filename of resolved RIIS data.
...
def parallel_annotate_multiprocess(input_filenames, main_logger):
    ...
    with Pool(cpu_count()-2) as pool:
        for in_csv in infiles:
            datapath, basefname = os.path.split(in_csv)
            ...
            pool.apply(annotate_occurrence_file, args=(in_csv, orig_riis_filename, logger))
